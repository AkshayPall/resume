...
\begin{itemize}[noitemsep,leftmargin=20pt,label=\raisebox{0.25ex}{\tiny$\bullet$},topsep=5pt]
  \small
    ...
    \item Implemented query filter pushdown optimizations to move portion of compute to storage
\end{itemize}
...
{\hfill \footnotesize \textit{June 2021}
\begin{itemize}[noitemsep,leftmargin=20pt,label=\raisebox{0.25ex}{\tiny$\bullet$},topsep=5pt]
    \small
...
\quarterspace
\footnotesize
\noindent \textit{Sep 2016 - May 2021} - With Distinction, Dean's Honours List
