...
\begin{center}
  ...
  \halfspace %TODO: remove this later when more space is needed
  \smolboispace
  \smolboispace
...
{\hfill \footnotesize \textit{September 2020 - Present}}
\begin{itemize}[noitemsep,leftmargin=20pt,label=\raisebox{0.25ex}{\tiny$\bullet$},topsep=5pt]
  \small
 
  \item Working on the Target Determinator (TD) which determines what to build and test as part of the continuous integration (CI) flow for Android

  \item Migrating and updating TD logic from PHP implementation to a new system with declarative rules written in Starlark
...
\noindent 87\% cumulative GPA, \textit{3x Term Dean's Honours List}
